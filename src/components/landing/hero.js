...
<div class="flex items-start ml-20 mt-20">
    <div class="flex items-center justify-between h-30">
        <div class="flex flex-col px-4">
            ...
            <Link to="/login"><div className=' text-black mt-10 hover:scale-20 hover:cursor-pointer transition duration-300 ease-in-out hover:-translate-y-1 py-1 pb-3 '><Button variant="contained" classname="h-12 px-6 m-2 text-[13px] sm:text-[20px] text-black" size="large" sx={{paddingX:3, fontFamily:'Inter', color:'#000', fontWeight:600, background: 'linear-gradient(45deg,  #748AFF 20%, #FFFAFA 90%)'}}>Get Started</Button></div></Link>
      </div>
    </div>
